...
def growthanddevelopment_dsc1(temperature: float, foodcon: float, strmass: float, maxzd: int, actzd: int, temporalres: int) -> float:
    ...
    #food concentration in carbon units (assuming non-limiting food supply)
    foodcon_carbon = foodcon * chltocarbon
    ...
    ingestionrate_food = ingestionrate_temp * ((food1_ingestioncoef * foodcon_carbon) / (1.00 + food1_ingestioncoef * foodcon_carbon))
